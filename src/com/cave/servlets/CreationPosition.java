...
@WebServlet( "/creationPosition" )
public class CreationPosition extends HttpServlet {
    ...
    public void init() throws ServletException {
        this.positionDao = ( (DAOFactory) getServletContext().getAttribute( CONF_DAO_FACTORY ) )
                .getPositionDao();
    ...
    public void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
        ...
        if ( sessionUtilisateur != null ) {
            ...
            if ( idRangee != null ) {
                Long id_rangee = Long.parseLong( idRangee );
                session.setAttribute( ATT_ID_RANGEE, id_rangee );
                try {
                    positionDao.creer( id_rangee );
